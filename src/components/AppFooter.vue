<template>
  <v-footer height="51" app>
    ...
    >
      <span class="d-none d-sm-inline-block">&copy; Created with 💖 by </span> Amiw
      —
      <!-- <a
...
<script setup>
  const items = [
    ...
    },
    {
      title: 'Amiw Facebook',
      icon: 'mdi-facebook',
      href: 'https://www.facebook.com/amiwdzh',
    },
    {
      title: 'Amiw X',
    ...
    },
    {
      ...
      href: 'https://www/discordapp.com/users/454985541327519744',
    },
    {
      title: 'Amiw Instagram',
      icon: `mdi-instagram`,
      href: 'https://instagram.com/amiw.dzh',
    },
  ]
</script>
